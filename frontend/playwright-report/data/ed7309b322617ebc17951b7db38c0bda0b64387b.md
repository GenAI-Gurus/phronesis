...
- Name: User Registration & Authentication >> Login with correct and incorrect credentials
- Location: /Users/carloshvp/Documents/Phronesis/frontend/tests/e2e/auth.spec.ts:24:7
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    at /Users/carloshvp/Documents/Phronesis/frontend/tests/e2e/auth.spec.ts:28:16
```
