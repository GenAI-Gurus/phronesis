...
- Name: User Registration & Authentication >> JWT is issued and used for all protected endpoints
- Location: /Users/carloshvp/Documents/Phronesis/frontend/tests/e2e/auth.spec.ts:73:7
...
Call log:
  - waiting for locator('input[name="email"]')
    ...
    at /Users/carloshvp/Documents/Phronesis/frontend/tests/e2e/auth.spec.ts:76:16
```
